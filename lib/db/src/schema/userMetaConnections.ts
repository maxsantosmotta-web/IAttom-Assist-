...
export const userMetaConnections = pgTable(
  ...
  (table) => [
    index("user_meta_connections_clerk_user_id_idx").on(table.clerkUserId),
  ],
);

export type UserMetaConnection = typeof userMetaConnections.$inferSelect;
export type NewUserMetaConnection = typeof userMetaConnections.$inferInsert;
