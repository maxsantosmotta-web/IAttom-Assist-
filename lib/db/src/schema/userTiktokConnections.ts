...
export const userTiktokConnections = pgTable(
  ...
  (table) => [
    index("user_tiktok_connections_clerk_user_id_idx").on(table.clerkUserId),
  ],
);

export type UserTiktokConnection = typeof userTiktokConnections.$inferSelect;
export type NewUserTiktokConnection = typeof userTiktokConnections.$inferInsert;
