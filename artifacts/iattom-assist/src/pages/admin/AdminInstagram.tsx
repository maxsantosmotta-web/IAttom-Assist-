...
export function AdminInstagram() {
  ...
  const kpis = [
    { label: "Usuários Conectados", value: "—", icon: Users,    color: "text-pink-400"    },
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Monitoramento de conexões dos usuários com o Instagram.</p>
            </div>
          </div>
      ...
      <Card className="bg-white/3 border-white/8">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-10 text-center gap-2">
            ...
            <p className="text-sm text-zinc-500">Nenhum usuário conectado ao Instagram.</p>
