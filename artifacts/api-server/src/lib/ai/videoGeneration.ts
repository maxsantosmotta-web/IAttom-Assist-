...
export async function streamVideoGeneration(
  ...
  try {
    ...
    // Seleção por catálogo oficial: estilo escolhido pelo usuário × gênero escolhido
    // params.videoEstilo tem prioridade absoluta — sem interpretação automática do prompt.
